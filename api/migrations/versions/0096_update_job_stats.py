...
def upgrade():
    query = "UPDATE job_statistics  " "set sent = sms_sent + emails_sent + letters_sent, " " delivered = sms_delivered + emails_delivered, " " failed = sms_failed + emails_failed + letters_failed "
