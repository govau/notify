...
def upgrade():
    ...
    # Set indexes
    op.create_index(
        op.f('ix_ft_billing_bst_date'), 'ft_billing', ['bst_date'], unique=False
    )
    op.create_index(
        op.f('ix_ft_billing_service_id'), 'ft_billing', ['service_id'], unique=False
    )
    ...
    # Set indexes
    op.create_index(
        op.f('ix_dm_datetime_yearmonth'), 'dm_datetime', ['year', 'month'], unique=False
    )
    op.create_index(
        op.f('ix_dm_datetime_bst_date'), 'dm_datetime', ['bst_date'], unique=False
    )
