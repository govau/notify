...
def upgrade():
    ...
    op.get_bind()
    query = 'update templates_history set created_by_id = ' '(select created_by_id from templates where templates.id = templates_history.id) ' 'where created_by_id is null'
    op.execute(query)
