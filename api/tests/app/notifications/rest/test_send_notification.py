...
def test_create_template_raises_invalid_request_when_content_too_large(
    ...
    try:
        ...
        assert e.message == {'content': ['Content has a character count greater than the limit of {}'.format(SMS_CHAR_COUNT_LIMIT)]}
...
@pytest.mark.parametrize(
    'template_factory, to, expected_error', [
        (sample_template_without_sms_permission, '+61412345678', 'Cannot send text messages'),
