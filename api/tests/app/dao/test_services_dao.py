...
def test_dao_fetch_live_services_data(sample_user, mock):
    ...
    create_ft_billing(aet_date='2019-04-20', notification_type='sms', template=template, service=service)
    create_ft_billing(aet_date='2019-04-21', notification_type='sms', template=template, service=service)
    # one sms billing record for 1st service from previous financial year, should not appear in the result:
    create_ft_billing(aet_date='2018-04-20', notification_type='sms', template=template, service=service)
    # one email billing record for 1st service within current financial year:
    create_ft_billing(aet_date='2019-04-20', notification_type='email', template=template2, service=service)
    # one letter billing record for 1st service within current financial year:
    create_ft_billing(aet_date='2019-04-15', notification_type='letter', template=template_letter_1, service=service)
    # one letter billing record for 2nd service within current financial year:
    create_ft_billing(aet_date='2019-04-16', notification_type='letter', template=template_letter_2, service=service_2)
...
def test_dao_fetch_todays_stats_for_all_services_groups_correctly(notify_db, notify_db_session, service_factory):
    ...
    assert (service1.id, service1.name, service1.restricted, service1.research_mode, service1.active,
            service1.created_at, service1.organisation_type, 'sms', 'created', 2) in stats
    assert (service1.id, service1.name, service1.restricted, service1.research_mode, service1.active,
            service1.created_at, service1.organisation_type, 'sms', 'failed', 1) in stats
    assert (service1.id, service1.name, service1.restricted, service1.research_mode, service1.active,
            service1.created_at, service1.organisation_type, 'email', 'created', 1) in stats
    assert (service2.id, service2.name, service2.restricted, service2.research_mode, service2.active,
            service2.created_at, service1.organisation_type, 'sms', 'created', 1) in stats
...
def test_fetch_stats_by_date_range_for_all_services(notify_db, notify_db_session):
    ...
    assert results[0] == (result_one.service.id, result_one.service.name, result_one.service.restricted,
                          ...
                          result_one.service.created_at, result_one.service.organisation_type, 'sms', 'created', 2)
...
def test_fetch_stats_by_date_range_for_all_services_returns_test_notifications(notify_db,
    ...
    assert results[0] == (result_one.service.id, result_one.service.name, result_one.service.restricted,
                          ...
                          result_one.service.organisation_type, 'sms', 'created', int(expected))
