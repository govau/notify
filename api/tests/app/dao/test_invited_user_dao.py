...
def test_get_invited_user_by_service_and_id(
    notify_db, notify_db_session, sample_invited_user
):
...
def test_get_unknown_invited_user_returns_none(
...
def make_invitation(
    user, service, age=timedelta(hours=0), email_address="test@test.com"
):
