...
from app.dao.letter_rate_dao import (
    dao_create_letter_rate,
    get_letter_rates_for_daterange,
)
...
def test_get_letter_rates_for_daterange(notify_db_session):
    ...
    results = get_letter_rates_for_daterange(
        date=datetime(2017, 12, 2), crown=True, sheet_count=1, post_class='second'
    )
