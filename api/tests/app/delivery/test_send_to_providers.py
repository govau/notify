...
import app
from app import telstra_sms_client, sap_sms_client
...
def test_should_send_personalised_template_to_correct_sms_provider_and_persist(
    ...
    mocker.patch('app.telstra_sms_client.send_sms', return_value=['MMXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX', NOTIFICATION_SENDING])
...
@pytest.mark.parametrize("client_send", ["app.telstra_sms_client.send_sms", "app.telstra_sms_client.send_sms"])
...
def test_should_send_sms_to_international_providers(
    ...
    mocker.patch('app.sap_sms_client.send_sms', return_value=['MMXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX', NOTIFICATION_SENDING])
...
def test_should_send_international_sms_with_formatted_phone_number(
    ...
    send_notification_mock = mocker.patch('app.sap_sms_client.send_sms', return_value=['MMXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX', NOTIFICATION_SENDING])
    mocker.patch('app.delivery.send_to_providers.send_sms_response')
...
def test_send_sms_to_provider_should_format_phone_number(
    ...
    send_mock = mocker.patch('app.telstra_sms_client.send_sms', return_value=['MMXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX', NOTIFICATION_SENDING])
