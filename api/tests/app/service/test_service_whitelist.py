...
def test_get_whitelist_separates_emails_and_phones(client, sample_service):
    dao_add_and_commit_whitelisted_contacts([
        ...
        ServiceWhitelist.from_string(sample_service.id, MOBILE_TYPE, '0412345678'),
        ServiceWhitelist.from_string(sample_service.id, MOBILE_TYPE, '+1800-555-5555'),
    ])
    ...
    assert sorted(json_resp['phone_numbers']) == sorted(['+1800-555-5555', '0412345678'])
...
def test_update_whitelist_replaces_old_whitelist(client, sample_service_whitelist):
    ...
    assert whitelist[0].recipient == '0412345678'
