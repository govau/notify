...
from sqlalchemy import Date as sql_date, asc, cast, desc, func
...
def dao_get_notification_outcomes_for_job(service_id, job_id):
    ...
    return (
        query.filter(NotificationHistory.service_id == service_id)
...
def dao_get_jobs_by_service_id(
    service_id, limit_days=None, page=1, page_size=50, statuses=None
):
    query_filter = [
