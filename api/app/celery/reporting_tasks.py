...
def get_rate(
    ...
    if notification_type == LETTER_TYPE:
        return next(
            ...
            if date > r[0] and crown == r[1] and rate_multiplier == r[2]
        )
    elif notification_type == SMS_TYPE:
        return next(
            r[2] for r in non_letter_rates if notification_type == r[0] and date > r[1]
        )
    else:
        return 0
    ...
    for i in range(0, 3):
        ...
        for data in transit_data:
            update_count = FactBilling.query.filter(
                ...
                == data.sent_by,  # This could be zero - this is a bug that needs to be fixed.
