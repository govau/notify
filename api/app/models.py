...
from app.utils import convert_utc_to_aest, convert_aest_to_utc
...
class Notification(db.Model):
    ...
    def serialize_for_csv(self):
        created_at_in_aest = convert_utc_to_aest(self.created_at)
        serialized = {
            ...
            "created_at": time.strftime('%A %d %B %Y at %H:%M', created_at_in_aest.timetuple())
        }
